...
COMMENT ON COLUMN dt_relation_history.blocks IS  'User1 blocks User2';
COMMENT ON COLUMN dt_relation_history.mutes IS    'User1 mutes User2';
...
BEGIN
	INSERT INTO dt_relation_history (
		...
		NEW.follows, NEW.blocks, NEW.mutes
